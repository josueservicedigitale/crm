                ...
                <div class="bg-white rounded shadow-sm p-4">
                    <form method="GET" action="{{ route('back.dossiers.index') }}" class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="search" class="form-control" placeholder="Nom du dossier..."
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="visibilite" class="form-select">
                                ...
                                <option value="public" {{ request('visibilite') == 'public' ? 'selected' : '' }}>Publics
                                </option>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex flex-wrap gap-1">
                                    ...
                                    <span class="badge bg-{{ $dossier->statut_badge_class }}" data-bs-toggle="tooltip"
                                ...
                                <div class="btn-group">
                                    <a href="{{ route('back.dossiers.show', $dossier->slug) }}"
                                        class="btn btn-sm btn-outline-primary" data-bs-toggle="tooltip" title="Ouvrir">
