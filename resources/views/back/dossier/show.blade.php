    ...
    <div class="row mb-4">
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('back.dossiers.index') }}" class="text-decoration-none">Dossiers</a></li>
            ...
            <div class="bg-white rounded shadow-sm p-4">
                ...
                <div class="upload-area" id="uploadArea">
                    <form id="uploadForm" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <input type="file" name="fichiers[]" id="fichiers" class="form-control" multiple accept=".pdf,.doc,.docx,.xls,.xlsx,.jpg,.jpeg,.png,.gif">
                        </div>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <button type="button"
                                            ...
                                            data-bs-toggle="tooltip" title="Aperçu">
