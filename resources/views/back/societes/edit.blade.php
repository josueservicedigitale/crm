...
@section('title', 'Modifier - ' . $societe->nom)
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="bg-white rounded shadow-sm p-4 mb-4">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <p class="text-muted mb-0">Modifiez les informations de {{ $societe->nom }}</p>
                    </div>
                    <div>
            ...
            <div class="card border-0 shadow-sm">
                <form action="{{ route('back.societes.update', $societe->code) }}" 
                      method="POST" 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-4">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" 
                                                       ...
                                                       name="est_active" 
                                                       value="1" 
                                                       {{ old('est_active', $societe->est_active) ? 'checked' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="code" 
                                                   name="code" 
                                                   value="{{ old('code', $societe->code) }}" 
                                                   readonly>
                                            @error('code')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <div class="form-text">Identifiant unique (non modifiable)</div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="color-picker">
                                                <input type="color" 
                                                       ...
                                                       id="couleur" 
                                                       name="couleur" 
                                                       value="{{ old('couleur', $societe->couleur ?: '#3B82F6') }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('icon') is-invalid @enderror" 
                                                ...
                                                @foreach($icones as $value => $label)
                                                    <option value="{{ $value }}" 
                                                            data-icon="{{ $value }}"
                                                            {{ old('icon', $societe->icon ?: 'fa-building') == $value ? 'selected' : '' }}>
                                                        {{ $label }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            ...
                                            <div class="mt-2 text-center">
                                                <div class="icon-preview d-inline-block p-3 rounded"
                                                     style="background-color: {{ old('couleur', $societe->couleur ?: '#3B82F6') }};">
                                                    <i class="{{ old('icon', $societe->icon ?: 'fa-building') }} fa-2x text-white"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" 
                                                       ...
                                                       value="{{ old('tva_intracommunautaire', $societe->tva_intracommunautaire) }}" 
                                                ...
                                                <div class="col-md-4 col-lg-3 mb-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" 
                                                               ...
                                                               {{ in_array($activite->id, old('activites', $societe->activites->pluck('id')->toArray())) ? 'checked' : '' }}>
            ...
            <div class="card border-0 shadow-sm border-danger mt-4">
                <div class="card-body">
                    ...
                    <form action="{{ route('back.societes.destroy', $societe->code) }}" 
                          method="POST" 
                          id="deleteForm"
                        ...
                        <button type="submit" class="btn btn-danger">
                            <i class="fas fa-trash me-1"></i> Supprimer cette société
                        </button>
                    </form>
                </div>
            </div>
...
/* Style pour la zone de suppression */
.card.border-danger {
...
$(document).ready(function() {
    ...
    function handleLogoUpload(file) {
        ...
        // Décocher "supprimer le logo" si coché
        if ($('#remove_logo').is(':checked')) {
    ...
    $('#remove_logo').on('change', function() {
        if ($(this).is(':checked')) {
            ...
            toastr.warning('Le logo actuel sera supprimé');
        }
    });
    ...
    $('#societeForm').on('submit', function(e) {
        ...
        // Afficher un loader
        $('button[type="submit"]').prop('disabled', true).html('<i class="fas fa-spinner fa-spin me-1"></i> Enregistrement...');
    });
        ...
        return Swal.fire({
            ...
            html: `
                <div class="text-center">
                    ...
                    <p class="mb-1">Vous êtes sur le point de supprimer :</p>
                    <p class="fw-bold text-danger">"{{ $societe->nom }}"</p>
