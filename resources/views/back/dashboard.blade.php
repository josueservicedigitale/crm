...
@section('content')
    <div class="container-fluid pt-4 px-4">
        ...
        <marquee behavior="alternate" direction="left" scrollamount="6" style="width:100%;" loop="1">

            <!-- TEXTE PRINCIPAL 3D CLIGNOTANT AVEC NOM -->
            <h1 class="display-3 fw-extrabold mb-3 text-3d-pulse text-center" style="font-family: 'Poppins', 'Montserrat', sans-serif;
            ...
            <h2 class="display-4 fw-black mb-3 text-user-name text-center" style="font-family: 'Poppins', 'Montserrat', sans-serif;
                       text-shadow: 0 1px 0 #ccc, 0 2px 0 #c9c9c9, 0 3px 0 #bbb,
                       0 4px 0 #b9b9b9, 0 5px 0 #aaa,
                       0 6px 1px rgba(0,0,0,.1), 0 0 5px rgba(0,0,0,.1),
                       0 1px 3px rgba(0,0,0,.3), 0 3px 5px rgba(0,0,0,.2),
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            <h6 class="text-primary text-uppercase small fw-bold mb-1">Documents Totaux</h6>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            <h6 class="text-success text-uppercase small fw-bold mb-1">Sociétés Actives</h6>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            <h6 class="text-warning text-uppercase small fw-bold mb-1">Activités</h6>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            <h6 class="text-info text-uppercase small fw-bold mb-1">Utilisateurs</h6>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end pe-4">
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <!-- SUPPRIMER -->
                                                    <form action="{{ $doc['url_delete'] }}" method="POST"
