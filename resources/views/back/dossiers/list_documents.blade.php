        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('back.dashboard', [$activity, $society]) }}" class="btn btn-outline-primary">
                                    ...
                                    <tbody>
                                        @foreach($documents as $doc)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($doc->montant_ttc)
                                                        <span class="fw-bold">{{ number_format($doc->montant_ttc, 2, ',', ' ') }}
                                                            €</span>
                                                        @if($doc->prime_cee)
                                                            <br>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm">
                                                        ...
                                                        <div class="btn-group btn-group-sm">
                                                            ...
                                                            <!-- ✏️ MODIFIER - Reste dans l'application -->
                                                            <a href="{{ route('back.document.edit', [$doc->activity, $doc->society, $doc->type, $doc->id]) }}"
                                                                class="btn btn-outline-warning" title="Modifier le document">
                                                                <i class="fa fa-edit"></i>
                                                                <span class="d-none d-lg-inline ms-1">Modifier</span>
                                                            </a>

                                                            <!-- ⬇️ TÉLÉCHARGER - Télécharge le PDF -->
                                                            <a href="{{ route('back.document.download', [$doc->activity, $doc->society, $doc->type, $doc->id]) }}"
                                                                class="btn btn-outline-success" title="Télécharger le PDF">
                                                        ...
                                                        @if($doc->type === 'devis')
                                                            ...
                                                            <a href="{{ route('back.document.facture.create', [$doc->activity, $doc->society, $doc->id]) }}"
                                                                class="btn btn-outline-success" title="Créer facture">
                                                            ...
                                                            <div class="btn-group">
                                                                <button type="button" class="btn btn-outline-secondary dropdown-toggle"
                                                                    data-bs-toggle="dropdown" title="Créer attestation">
                        ...
                        @else
                            ...
                            <div class="text-center py-5">
                                ...
                                <div class="d-flex justify-content-center gap-3">
                                    ...
                                    <a href="{{ route('back.documents.creation-rapide') }}" class="btn btn-outline-primary">
        ...
        <tr>
            ...
            <td>
                @if($document->pdf_path)
                    <a href="{{ Storage::url($document->pdf_path) }}" target="_blank" class="btn btn-sm btn-info">
                        <i class="fa fa-eye"></i>
                    </a>
