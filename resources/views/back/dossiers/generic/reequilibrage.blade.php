...
@section('title', 'Rééquilibrage - ' . $societyName)
...
<div class="container-fluid pt-4 px-4">
    ...
    <div class="row mb-4">
        <div class="col-12 text-center text-md-start">
            <h4 class="fw-bold" style="color: {{ $societyColor }};">
                <i class="fa fa-balance-scale me-2" style="color: {{ $societyColor }};"></i>
                Bienvenue sur le Rééquilibrage – {{ $societyName }} {{ auth()->user()->name }}
            </h4>
    ...
    <!-- Cartes Documents (MÊME CONTENU QUE L'AUTRE VUE) -->
    <div class="row g-4">
        @php
            $documents = [
