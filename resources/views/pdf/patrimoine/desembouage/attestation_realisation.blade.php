...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .top-title-box .t2{ color: #38bdf8;  font-weight: 900; font-size: 10.5pt; margin-bottom: 1mm; }
    .top-title-box .t3{ color: #38bdf8;  font-weight: 900; font-size: 10.5pt; }

    /* ===================== TEXT UTILS ===================== */
    .brand-green{ color: #38bdf8;; font-weight: 800; }
    .title-blue{ color: #38bdf8; font-weight: 800; }
    ...
    .h-section{ color: #38bdf8; font-weight: 900; font-size: 11pt; margin-bottom: 3mm; }
  ...
  <div class="page">
    ...
    <div class="hdr">
      <table class="hdr-table">
        <tr>
          <td class="logo-left">
            <img src="{{ public_path('assets/img/patrimoine/patr.png') }}" alt="PATRIMOINE">
          </td>
          <td></td>
          <td class="logo-right">
    ...
    <div class="content">
      ...
      <table class="party">
        <tr>
          <td class="col">
            <h4 class="brand-green">PATRIMOINE</h4>
            <div class="kv tiny">
            ...
            <div class="kv tiny" style="margin-top:3mm;">
              ...
              <span class="muted">direction@patrimoine.fr</span>
            </div>
          ...
          <td class="col" style="padding-left:10mm;">
            ...
            <div class="kv tiny">
              <b class="title-blue" style="min-width:auto; display:block; color: #38bdf8;">
            ...
            <div class="kv tiny" style="margin-top:3mm;">
              <b style="color: #38bdf8;">SIRET</b> {{ $document->beneficiaire_siret ?? '44261333700033' }}<br>
              <b style="color: #38bdf8;">MAIL</b> {{ $document->beneficiaire_mail ?? 'contact@rabatherm-hecs.fr' }}<br>
              <b style="color: #38bdf8;">TEL</b> {{ $document->beneficiaire_tel ?? '01 84 80 90 08' }}<br><br>
              <b style="color: #38bdf8;">REPRÉSENTÉ PAR</b> {{ $document->beneficiaire_representant ?? 'M. Offel de Villaucourt Charles' }}<br>
              <b style="color: #38bdf8;">FONCTION</b> {{ $document->beneficiaire_fonction ?? 'Gérant' }}
            </div>
          </td>
        </tr>
      </table>
  ...
  <div class="page">
    ...
    <div class="content">
      ...
      <div class="section" style="margin-top:7mm;">
        <div class="h-sub" style="font-size:11pt; color: #38bdf8;">3. CERTIFICATION</div>

        <div class="cert">
          <p>
            Je soussigné, <span class="name">M. TAMOYAN Hamlet</span> président de
            <span class="brand-green">PATRIMOINE ENERGIE</span>, atteste que :
          </p>
          ...
          <div class="signature">
            ...
            <div class="stamp">
              <img src="{{ public_path('assets/img/nova/attestation_realisation_files/Image_012.png') }}" alt="Cachet PATRIMOINE">
            </div>
          </div>
        </div>
      </div>
