    ...
    <div class="page">
        <div class="frame">
            ...
            <p class="small">
                ...
                charge de l’énergie impose à l’ensemble des fournisseurs d’énergie (électricité, gaz, fioul domestique,
                chaleur ou froid, carburants automobiles), de réaliser des économies et de promouvoir les comportements
                vertueux auprès des consommateurs d’énergie.
            </p>
            ...
            <p class="tiny muted">
                ...
                disponibles sur le site du Ministère en charge de l’énergie, et pourront être actualisés en fonction
                des paramètres relatifs aux travaux réalisés et de la situation fiscale du ménage.
                <br><br>
                ...
                est non cumulable avec une autre offre liée au dispositif des Certificats d’Économies d’Énergie.
                <br><br>
                Cet engagement est valable pour les travaux réalisés jusqu’à 1 an après la date d’édition du devis
                (date de factures des travaux faisant foi).
                <br><br>
                Dans le cadre de la réglementation, un contrôle qualité des travaux sur site par un contact pourra être demandé.
                Un refus de ce contrôle sur site ou par contact via EBS ENERGIE ou un prestataire d’EBS ENERGIE conduira au refus
                de cette prime par EBS ENERGIE.
            </p>
