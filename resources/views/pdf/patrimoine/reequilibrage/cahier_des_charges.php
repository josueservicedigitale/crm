        ...
        <div class="frame">
            ...
            <table class="hdr">
                <tr>
                    ...
                    <td class="right">
                        <!-- Logo PATRIMOINE -->
                        <img class="logo-nova" src="{{ public_path('assets/img/patrimoine/patr.png') }}"
                            alt="PATRIMOINE" />
                    </td>
                </tr>
            </table>
            ...
            <p class="small">
                Dans le cadre de son partenariat avec la société EBS ENERGIE, la société (PATRIMOINE) s’engage à vous
                apporter :
            </p>
                ...
                <table class="sig-grid">
                    <tr>
                        ...
                        <td class="sig-mid tiny">
                            ...
                            <div>
                                <img class="stamp" src="{{ public_path('assets/img/patrimoine/patrim.png') }}"
                                    alt="Cachet PATRIMOINE">
                            </div>
                        </td>
