...
<body>
        ...
        <div class="page-break">
            ...
            <table class="logos-top">
                <tr>
                    ...
                    <td class="center"><img src="{{ public_path('assets/img/nova/cdc_files/Image_010.jpg') }}"
    ...
    <div style="page-break-before:always" class="container">
        ...
        <table class="logos-top">
            <tr>
                <td><img src="{{ public_path('assets/img/nova/cdc_files/Image_009.jpg') }}"></td>
                <td class="center"><img src="{{ public_path('assets/img/nova/cdc_files/Image_010.jpg') }}" width="80%"
                        height="60px"></td>
                <td class="right"><img src="{{ public_path('assets/img/nova/cdc_files/Image_011.png') }}"></td>
            </tr>
        </table>
        ...
        <div class="banner-container">
            <img src="/assets/img/rehouse/Cdc_files/image_009.png" class="banner-img">
