...
.logos-top td{ width:33%; }
.logos-top img{ height:60px; }
...
<tr>
<td>
<img src="{{ public_path('assets/img/nova/cdc_files/Image_003.jpg') }}">
</td>
<td class="center">
<img src="{{ public_path('assets/img/nova/cdc_files/Image_001.jpg') }}" width="80%" height="60px">
</td>
<td class="right">
<img src="{{ public_path('assets/img/nova/cdc_files/Image_002.png') }}">
</td>
</tr>
</table>
...
l’ensemble des fournisseurs d’énergie (électricité, gaz, fioul domestique, chaleur ou froid, carburants automobiles), de réaliser des
...
<table style="width:100%; border-collapse:collapse; margin-top:8px;">
    <tr>
        ...
        <td>
            une prime d’un montant de 8 026,20 € * ;
        </td>
    </tr>
...
<table class="logos-top">
<tr>
<td><img src="{{ public_path('assets/img/nova/cdc_files/Image_009.jpg') }}"></td>
<td class="center"><img src="{{ public_path('assets/img/nova/cdc_files/Image_010.jpg') }}" width="80%" height="60px"></td>
<td class="right"><img src="{{ public_path('assets/img/nova/cdc_files/Image_011.png') }}"></td>
</tr>
</table><br><br><br>
...
<br><br><br><br><br><br>
  ...
  <!-- Avertissement -->
    ...
    <img src="/assets/img/rehouse/Cdc_files/image_009.png" alt="banniere" class="banner-img">
