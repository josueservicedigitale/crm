...
<head>
  <meta charset="UTF-8">
  <title>Facture - ENERGIE NOVA</title>
  ...
  <style>
    ...
    :root{
      ...
      --tbl:#003366;
      --gray:#f0f0f0;
      --frame:180mm; /* 210 - 15 - 15 = 180mm : largeur imprimable */
    }
    ...
    *{ margin:0; padding:0; box-sizing:border-box; }
    ...
    .page-content{
      width: var(--frame);
      margin: 5mm auto;
      padding: 5mm;              /* le cadre fait déjà les marges */
    }

    /* Safety overflow */
    img, table, div{ max-width: 100%; }
    img{ height:auto; }
    ...
    .para{ margin: 1.2mm 0; line-height: 1.25; }
    ...
    /* Header top (table) */
    .top{ margin: 0 0 4mm 0; }
    .top-table{ margin:0; }
    .top-table td{ border:none; padding:0; vertical-align: top; }

    .brand-inner{ margin:0; }
    .brand-inner td{ border:none; padding:0; }
    .brand-logo{ width: 18mm; }
    .brand-logo img{ width:18mm; height:18mm; object-fit: contain; }
    ...
    .cols td.left{ padding-right: 10mm; }
    .cols h4{
      margin:0 0 2mm 0;
      font-size: 9pt;
      color: var(--blue);
    ...
    .object .label{ font-weight: 800; color: var(--blue); }
    ...
    .w-detail{ width: 60%; }
    .w-qte{ width: 10%; text-align:center; }
    .w-pu{ width: 12%; text-align:center; }
    .w-total{ width: 12%; text-align:center; }
    .w-tva{ width: 6%; text-align:center; }

    /* Anti pages fantômes: éviter les colonnes vides énormes */
    table.grid4 thead th:nth-child(1){ width: 58%; }
    table.grid4 thead th:nth-child(2){ width: 10%; text-align:center; }
    table.grid4 thead th:nth-child(3){ width: 10%; text-align:center; }
    table.grid4 thead th:nth-child(4){ width: 12%; text-align:center; }
    table.grid4 thead th:nth-child(5){ width: 10%; text-align:center; }
    ...
    .bottomRow{ margin-top: 6mm; }
    .bottomRow td{ border:none; vertical-align: top; padding:0; }
    ...
    .totals{ padding-left: 8mm; font-size: 9pt; line-height: 1.55; }
    .totals-table{ margin:0; }
    .totals-table td{ border:none; padding: 1mm 0; font-weight: 800; }
    .totals-table .lbl{ color: var(--blue); text-transform: uppercase; }
    .totals-table .val{ text-align:right; width: 45mm; color:#000; }
    .totals-table .big{ font-size: 10.5pt; padding-top: 2mm; }
    .totals-table .rest{ font-size: 10.5pt; padding-top: 3mm; }
  </style>
</head>
  ...
  <div class="page">
    <div class="page-content">
      ...
      <table class="cols">
        <tr>
          <td class="left">
            ...
            <br>
            <div class="line"><span class="strong">Représenté par</span> M. TAMOYAN Hamlet, en qualité de Président</div>
      ...
      <div class="box">
        ...
        <div class="para"><span class="strong">NUMÉRO IMMATRICULATION DE COPROPRIÉTÉ :</span> {{ $document->numero_immatriculation }} - {{ $document->nom_residence }}</div>
        ...
        <div class="para">1&nbsp;&nbsp;Parcelle {{ $document->parcelle_1 }} Feuille {{ $document->parcelle_2 }}&nbsp;&nbsp;&nbsp;&nbsp;2</div>
        <div class="para">3&nbsp;&nbsp;{{ $document->parcelle_3 }}&nbsp;&nbsp;&nbsp;&nbsp;4&nbsp;&nbsp;{{ $document->parcelle_4 }}</div>

        <br>
        <div class="para"><span class="strong">DATE PRÉVISIONNELLE DES TRAVAUX :</span> {{ $document->dates_previsionnelles }}</div>
        ...
        <div class="para"><span class="strong">NOMBRE DE BÂTIMENTS :</span> {{ $document->nombre_batiments }} Bâtiments</div>
        ...
        <tbody>
          <tr>
            <td>
              ...
              <div class="para">
                <span class="strong" style="color:var(--blue);">PRIME CEE :</span> {{ number_format($document->prime_cee, 2, ',', ' ') }} €
              </div>
              <div class="para">
              ...
              <div class="strong" style="color:var(--blue);">LE DÉSEMBOUAGE COMPORTE LES ÉTAPES SUCCESSIVES SUIVANTES :</div>
              ...
              <div class="strong" style="color:var(--blue2); margin-top:10px;">CIRCULATION AVEC POMPE DE DÉSEMBOUAGE</div>
              <ul>
        ...
        <tbody>
          <tr>
            <td>
              ...
              <div class="sectionTitle" style="margin-top:14px;">C. VÉRIFICATION/INSTALLATION FILTRE ET INJECTION INHIBITEUR</div>

              <div class="strong" style="color:var(--blue2); margin-top:6px;">VÉRIFICATION DU SYSTÈME DE FILTRATION EXISTANT</div>
              <ul>
              ...
              <div class="strong" style="color:var(--blue2); margin-top:10px;">INSTALLATION DE FILTRES COMPLÉMENTAIRES (SI NÉCESSAIRE)</div>
              <ul>
              ...
              <div class="strong" style="color:var(--blue2); margin-top:10px;">INJECTION DU RÉACTIF INHIBITEUR SENTINEL X100</div>
              <ul>
                <li>Dosage : 1% du volume d’eau de l’installation</li>
              ...
              <div class="para">
                Sentinel X800 désembouant pour nettoyage d’un réseau de chauffage, élimine boues, particules de corrosion et dépôts de calcaire.
              </div>
              <ul>
                <li>Dosage : 1% du volume d’eau de l’installation</li>
        ...
        <tbody>
          <tr>
            <td>
              ...
              <div class="para">
                Sentinel X100 inhibiteur pour protection du réseau de chauffage avec agents inhibiteurs de corrosion et anti-tartre.
              </div>
                ...
                <tr>
                  <td style="width:55%; padding-right:8mm;">
                    <div class="paybox">
                      ...
                      <div class="para">
                        Prime versée sous réserve de validation, documents CEE nécessaires, et respect des exigences de l’opération.
                      </div>
                  ...
                  <td style="width:45%;">
                    <div class="totals">
                      <table class="totals-table">
                        <tr><td class="lbl">MONTANT TOTAL</td><td class="val">{{ number_format($document->montant_ht, 2, ',', ' ') }} €</td></tr>
                        <tr><td class="lbl">HT TVA</td><td class="val">{{ number_format($document->montant_tva, 2, ',', ' ') }} €</td></tr>
                        <tr><td class="lbl big">MONTANT TOTAL TTC</td><td class="val big">{{ number_format($document->montant_ttc, 2, ',', ' ') }} €</td></tr>
                        <tr><td class="lbl">PRIME CEE</td><td class="val">{{ number_format($document->prime_cee, 2, ',', ' ') }} €</td></tr>
                        <tr><td class="lbl rest">RESTE À CHARGE</td><td class="val rest">{{ number_format($document->reste_a_charge, 2, ',', ' ') }} €</td></tr>
                      </table>
                    </div>
                  </td>
                </tr>
