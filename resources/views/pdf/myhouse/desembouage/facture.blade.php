...
<body>
    ...
    <div class="content-container">
        <img src="{{ public_path('assets/img/house/Facture_files/Image_001.jpg') }}" alt="Logo" class="logo">

        <div class="mb-15">
            <span class="h1">FACTURE {{ $document->reference_facture }}</span>
            <p class="s1 mt-10">Date : {{ $document->date_facture }}</p>
        </div>

        <table width="100%" style="margin-top:10px;">
            <tr>
                <td width="60%" style="vertical-align: top; padding-right:10px;">
                    <p class="s1"><b>Date :</b> {{ $document->date_facture }}</p>
    ...
    <div class="page-start">
        <div class="content-container">
            ...
            <div class="mt-15">
                <span class="h1">FACTURE M'YHOUSE-2025-{{ $document->reference_facture }}</span>
