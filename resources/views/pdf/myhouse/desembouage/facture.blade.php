...
<head>
    <meta charset="UTF-8" />
    <title>Facture M'YHOUSE-2025-F{{ $document->reference_facture }}</title>
        ...
        <div class="page-content">
            ...
            <div class="header">
                <img src="{{ public_path('assets/img/house/Devis_files/Image_001.jpg') }}" alt="MY HOUSE"
                    class="logo"><br>
                <div class="bar">FACTURE M'YHOUSE-2025-F{{ $document->reference_facture }}</div>
            </div>
                ...
                <tr>
                    <td class="left-info" style="width:60%;">
                        <p><span class="bold">Date :</span>
                            {{ \Carbon\Carbon::parse($document->date_facture)->format('d/m/Y') }}</p>
