        ...
        <div class="frame">
            ...
            <table class="hdr">
                <tr>
                    <td class="left">
                        <!-- Logo CEE -->
                        <img class="stamp" src="{{ public_path('assets/img/house/Cdc_files/Image_001.jpg') }}" alt="M'Y HOUSE">
                    </td>

                    <td class="mid">
                        <!-- Logo EBS ENERGIE -->
                        <img class="stamp" src="{{ public_path('assets/img/house/Cdc_files/Image_007.jpg') }}" alt="M'Y HOUSE">
                    </td>

                    <td class="right">
                        <!-- Logo partenaire -->
                        <img class="stamp" src="{{ public_path('assets/img/house/Cdc_files/Image_003.jpg') }}" alt="M'Y HOUSE">
                    </td>
                </tr>
            </table>
            ...
            <p class="tiny muted">
                ...
                non cumulable avec une autre offre liée au dispositif des Certificats d’Économies d’Énergie.
                <br><br>
