        ...
        <div class="frame">
            ...
            <table class="hdr">
                <tr>
                    <td class="left">
                        <!-- Logo CEE -->
                        <img class="stamp" src="{{ public_path('assets/img/house/Cdc_files/Image_001.jpg') }}"
                            alt="Cachet M'Y HOUSE">
                    </td>

                    <td class="mid">
                        <!-- Logo EBS ENERGIE (au lieu du texte) -->
                        <img class="stamp" src="{{ public_path('assets/img/house/Cdc_files/Image_007.jpg') }}"
                            alt="Cachet M'Y HOUSE">
                    </td>

                    <td class="right">
                        <!-- Logo ENERGIENOVA -->
                        <img class="stamp" src="{{ public_path('assets/img/house/Cdc_files/Image_003.jpg') }}"
                            alt="Cachet M'Y HOUSE">
                    </td>
                </tr>
            </table>
            ...
            <div class="small">
                <div>•&nbsp;&nbsp;Nom : <b>BBR MAINTENANCE</b></div>
                <div>•&nbsp;&nbsp;Prénom : _______________________</div>
                <div>•&nbsp;&nbsp;Adresse : <b>78 AVENUE DES CHAMPS ELYSEES, 75008 PARIS</b></div>
                <div>•&nbsp;&nbsp;Téléphone : <b>01 85 09 74 35</b></div>
                <div>•&nbsp;&nbsp;Adresse e-mail : <b>tech@bbrmaintenance.fr</b></div>
            </div>
                ...
                <table class="sig-grid">
                    <tr>
                        <td class="sig-left tiny">
                            Signature:<br>
                            NOM Prénom : <span style="color:#0a49b5;">Amblar Jean-Christophe</span><br>
                        ...
                        <td class="sig-mid tiny">
                            ...
                            <div>
                                <img class="stamp" src="{{ public_path('assets/img/house/Cdc_files/Image_005.png') }}"
                                    alt="Cachet M'Y HOUSE">
                            </div>
                        </td>
