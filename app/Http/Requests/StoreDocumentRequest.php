...
class StoreDocumentRequest extends FormRequest
{
    ...
    protected function prepareForValidation()
    {
        ...
        $this->merge([
            'produits_utilises' => $this->produits_utilises ? json_encode($this->produits_utilises) : null,
            'checkboxes' => $this->checkboxes ? json_encode($this->checkboxes) : null,
            'images' => $this->images ? json_encode($this->images) : null,
        ]);
    }
}